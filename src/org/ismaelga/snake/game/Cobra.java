...
/**
 * Classe cobra onde fica definido a localização da cabeça
 * e guardado as partes constituintes.
 * @Ismael
 * @04-2010
 */
public abstract class Cobra extends Actor 
{
    ...
    /**
     * Movimenta a cobra
     * @param lado Lado que a cobra se irá movimentar
    ...
    public void moveCobra(String lado, Terreno terreno)
    {
        ...
        else
        {
            ...
            }else
            {
                ...
                Actor actorNaPos = (Actor)terreno.getObjectAt(novaPos);
                ...
                {
                    ((Actor)corpo.get(i)).setPosicao(((Actor)corpo.get(i-1)).getPosicao());
                }
                //a primeira peça fica com a posicao anterior da cabeça
                ((Actor)corpo.get(0)).setPosicao(posActual);
     ...
     * @param posicao Posicao para nascer o novo pedaço de cobra
     */
    ...
    public void setLadoVirada(String lado)
    {
        ...
        if(!((ladoVirada.equals("direita") && lado.equals("esquerda")) ||
    ...
    /**
     * Muda o estado da cobra para morta e de todas as suas peçasque compoe o corpo.
     */
    public void setDead()
    {
        ladoVirada = null;
